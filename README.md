...
You can take part in the workshop in two ways, in the cloud or locally. Running the workshop in the cloud is recommended for inexperienced R-users, but you loose some functionality (related to parallelization). Should you wish to run the workshop in the cloud, switch to this repo:

https://github.com/love-borjeson/tm_ws_cloud. 

Otherwise, continue with the preparations below.
